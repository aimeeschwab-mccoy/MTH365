---
title: "Lab 5: Visualizing Weather Data"
...
## Other RMarkdown options

You're not limited to producing long-form documents in RMarkdown, you can create presentations too. There are several options:

1. ioslides_presentation
2. slidy_presentation
3. beamer_presentation
4. powerpoint_presentation

The documentation for each type of presentation can be found at the link below:

https://bookdown.org/yihui/rmarkdown/presentations.html

> 12. Change the output option for your document to an ioslides presentation. 

> 13. How does ioslides indicate "slide breaks" (i.e. changes to new slides)? Insert slide breaks so that the answer to each question is on its own slide. Include the question text on your slide - you might need multiple slides per question.

> 14. Change the font color of each question using base color classes (4.1.8).

> 15. Add a logo to your title slide. You should save the logo in the same directory as your RMarkdown document
