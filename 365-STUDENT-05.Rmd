...
paths_allowed("http://en.wikipedia.org")
```
...
# Save the webpage url as a ""
page <- read_html("http://www.imdb.com/chart/top")

# Reading in the titles and saving them to a titles variable
titles <- page %>%
  html_nodes(".titleColumn a") %>%
  html_text()

# Read in the years and clean up formatting
years <- page %>%
...
# Read in scores and reclass as numeric
scores <- page %>%
