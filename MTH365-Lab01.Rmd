...
You're done with Lab 1! Before you submit your Lab, there are two things I'd like you to do.
...
Once again click on the gear icon in on top of the R Markdown document, and select "Output Options..." in the dropdown menu. In the General tab of the pop up dialogue box try out different syntax highlighting and theme options. Hit OK and knit your document to see how it looks. Play around with these until you're happy with the look. (Your final choice should be something _other than the default_, so I know this step was completed.)
